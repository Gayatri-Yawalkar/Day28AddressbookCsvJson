...
public class MultipleAddressBooks {
	...
	public void sortByName() {
		for(Map.Entry<String,MultipleContacts> m:addressBookMap.entrySet()) {
			...
			ArrayList<Contacts> c=(ArrayList<Contacts>) 
					      ...
					      .sorted(Comparator.comparing(Contacts::getFirstLastName))
					      .collect(Collectors.toList());
	...
	public void writeCsv() {
		for(Map.Entry<String,MultipleContacts> m:addressBookMap.entrySet()) {
			try {
				new AddressBookCsvReaderWriter().writeData(m.getValue().contactArrayList,m.getKey());
			} catch(IOException e) {
				e.printStackTrace();
	...
	public void readCsv() {
		for(Map.Entry<String,MultipleContacts> m:addressBookMap.entrySet()) {
			try {
				new AddressBookCsvReaderWriter().readData(m.getKey());
			} catch(IOException e) {
				e.printStackTrace();
			}
		}
